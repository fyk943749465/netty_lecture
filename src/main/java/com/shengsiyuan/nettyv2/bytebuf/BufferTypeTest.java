...
public class BufferTypeTest {
    ...
    public void testHeapBuffer() {
        ...
        heapBuf.writeBytes("疯狂创客园:高性能学习社群".getBytes(UTF_8));
        if (heapBuf.hasArray()) {
            // 取得内部数组
    ...
    public void testDirectBuffer() {
        ...
        directBuf.writeBytes("疯狂创客园:高性能学习社群".getBytes(UTF_8));
    ...
    public static void main(String[] args) {
        BufferTypeTest bufferTypeTest = new BufferTypeTest();
        bufferTypeTest.testDirectBuffer();
    }
}
